    ...
    <div className="relative min-h-screen bg-slate-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-24 md:py-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Right Image/Visual */}
          <div className="relative lg:block animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 shadow-xl animate-float-slow">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-5 shadow-xl animate-float-slow" style={{ animationDelay: '0.5s' }}>
